...
namespace CMSpline {
    ...
    fp main_function_derivative1(fp x) {
        ...
        return ((x+1) * cos(x+1) - sin(x + 1)) / (x * x + 2 * x + 1);
    }

    fp main_function_derivative2(fp x) {
        if (std::abs(x + 1) < 1e-10) return -1.0 / 3.0;
        return ((2 - (x * x + 2 * x + 1)) * sin(x + 1) - 2 * (x + 1) * cos(x + 1)) / (x * x * x + 3 * x * x + 3 * x + 1);
    }
    ...
    fp oscillating_function_derivative1(fp x) {
        ...
        return ((x + 1) * cos(x + 1) - sin(x + 1)) / (x * x + 2 * x + 1) - 10 * sin(10 * x);
    }

    fp oscillating_function_derivative2(fp x) {
        if (std::abs(x + 1) < 1e-10) return -1.0 / 3.0 - 100 * cos(-10);
        return ((2 - (x * x + 2 * x + 1)) * sin(x + 1) - 2 * (x + 1) * cos(x + 1)) / (x * x * x + 3 * x * x + 3 * x + 1) - 100 * cos(10 * x);
    }
}